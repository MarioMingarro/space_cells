...
dir_result <- "C:/A_TRABAJO/CELLS_CLIMAREP/NATIONAL_PARKS/2"
...
reference_system <- terra::crs(present_climate_variables_filtered)
study_area <- read_sf("C:/A_TRABAJO/CELLS_CLIMAREP/Iberia_10km_AE.shp")
polygon <- read_sf("C:/A_TRABAJO/CELLS_CLIMAREP/NATIONAL_PARKS/national_parks_PI2.shp")
...
present_filtered_path <- "C:/A_TRABAJO/CELLS_CLIMAREP/present_climate_filtered.tif"
present_climate_variables_filtered <- terra::rast("C:/A_TRABAJO/CELLS_CLIMAREP/present_climate_filtered.tif")
...
tic()
ClimaRep::rep_overlay(folder_path = file.path("C:/A_TRABAJO/CELLS_CLIMAREP/NATIONAL_PARKS/2", "Representativeness"),
                      output_dir = "C:/A_TRABAJO/CELLS_CLIMAREP/NATIONAL_PARKS/2" )
toc()
